...
const DayData = ({ day,icon,high,low,unit }) => {
  return (
    <div className='mt-6 w-150 mx-5 max-sm:mx-1 max-sm:my-3 my-8 py-4 pr-4 max-sm:pr-2 rounded-2xl max-sm:w-full flex justify-evenly bg-[rgba(255,255,255,0.05)] border border-[rgba(74,144,217,0.18)]'>
