const WeatherSkeleton = () => {
  return (
    <div className="w-full max-w-180 m-12 rounded-2xl bg-[#1c2e4a] p-8 animate-pulse">
      ...
      {/* Stats Grid */}
      <div className="grid grid-cols-1 w-full mt-6 sm:grid-cols-2 gap-12">
        {[1, 2, 3, 4, 5, 6].map((item) => (
          <div
            key={item}
            className="h-32 w-58 m-2 flex rounded-xl bg-white/10"
          />
        ))}
      </div>
    </div>
